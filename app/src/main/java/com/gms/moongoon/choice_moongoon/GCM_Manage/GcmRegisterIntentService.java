...
public class GcmRegisterIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        // GCM Instance ID의 토큰을 가져오는 작업이 시작되면 LocalBoardcast로 GENERATING 액션을 알림.
        LocalBroadcastManager.getInstance(this).sendBroadcast(new Intent(GcmQuickStartPreference.REGISTRATION_GENERATING));
        ...
        Intent registrationComplete = new Intent(GcmQuickStartPreference.REGISTRATION_COMPLETE);
